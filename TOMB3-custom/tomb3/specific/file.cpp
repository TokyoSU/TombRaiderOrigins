...
long LoadSamples(HANDLE file)
{
	...
	MyReadFile(file, sample_lut, sizeof(short) * SFX_NUM_SAMPLES, &read, 0);
	...
	sfxFile = CreateFile(GetFullPath(tomb3.gold ? "datag\\main.sfx" : "data\\main.sfx"), GENERIC_READ, 0, 0, OPEN_EXISTING, FILE_ATTRIBUTE_NORMAL, 0);
