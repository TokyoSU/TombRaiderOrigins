...
enum object_types
{
	LARA, PISTOL_ANIM, HAIR, SHOTGUN_ANIM, DESERTEAGLE_ANIM, UZI_ANIM, MP5_ANIM, ROCKET_GUN_ANIM, GRENADE_GUN_ANIM, HARPOON_GUN_ANIM, FLARE,
	...
	PASSPORT_OPTION, STOPWATCH_OPTION, PHOTO_OPTION,
	PLAYER_1, PLAYER_2, PLAYER_3, PLAYER4, PLAYER_5, PLAYER_6, PLAYER_7, PLAYER_8, PLAYER_9, PLAYER_10,
	PASSPORT_CLOSED, MAP_CLOSED,
	PISTOL_ITEM, SHOTGUN_ITEM, DESERTEAGLE_ITEM, UZI_ITEM, HARPOON_ITEM, MP5_ITEM, ROCKET_GUN_ITEM, GRENADE_GUN_ITEM,
	GUN_AMMO_ITEM, SHOTGUN_AMMO_ITEM, DESERTEAGLE_AMMO_ITEM, UZI_AMMO_ITEM, HARPOON_AMMO_ITEM, MP5_AMMO_ITEM, ROCKET_AMMO_ITEM, GRENADE_AMMO_ITEM,
	...
	PISTOL_OPTION, SHOTGUN_OPTION, DESERTEAGLE_OPTION, UZI_OPTION, HARPOON_OPTION, MP5_OPTION, ROCKET_OPTION, GRENADE_OPTION,
	PISTOL_AMMO_OPTION, SHOTGUN_AMMO_OPTION, DESERTEAGLE_AMMO_OPTION, UZI_AMMO_OPTION, HARPOON_AMMO_OPTION, MP5_AMMO_OPTION, ROCKET_AMMO_OPTION, GRENADE_AMMO_OPTION,
	...
	GLOW,
	GUN_FLASH, MP5_FLASH, DESERT_EAGLE_FLASH, BODY_PART, CAMERA_TARGET,
	...
	TR1_ATLANTEAN, // Without wing model.
	TR1_ATLANTEAN_SOLDIER, // With wing or not.
	TR1_COWBOY,
	TR1_MRT,
	TR1_SKATEBOARD,
	TR1_SKATEBOARD_KID,
