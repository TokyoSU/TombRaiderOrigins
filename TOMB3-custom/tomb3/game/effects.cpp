...
void draw_right_gun(ITEM_INFO* item)
{
	...
	lara.mesh_ptrs[HAND_R] = meshes[objects[PISTOL_ANIM].mesh_index + HAND_R];
	meshes[objects[PISTOL_ANIM].mesh_index + HAND_R] = tmp;
}
...
void draw_left_gun(ITEM_INFO* item)
{
	...
	lara.mesh_ptrs[HAND_L] = meshes[objects[PISTOL_ANIM].mesh_index + HAND_L];
	meshes[objects[PISTOL_ANIM].mesh_index + HAND_L] = tmp;
}
