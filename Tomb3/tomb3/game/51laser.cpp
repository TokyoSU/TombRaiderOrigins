...
void ControlArea51Laser(short item_number)
{
	...
	TriggerDynamic(item->pos.x_pos, item->pos.y_pos - 64, item->pos.z_pos, (GetRandomControl() & 1) + 8, (GetRandomControl() & 0x1F) + 192, GetRandomControl() & 0x1F, GetRandomControl() & 7);
	...
	if (TestBoundsCollide(item, lara_item, 64))
	{
		...
		DoLotsOfBloodD(lara_item->pos.x_pos, item->pos.y_pos - (GetRandomControl() & 0xFF) - 32, lara_item->pos.z_pos, (GetRandomControl() & 0x7F) + 128, short(GetRandomControl() << 1), lara_item->room_number, 3);
	}
